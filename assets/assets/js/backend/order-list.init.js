...
xhttp.onload = function () {
    if (this.status === 200) {
        ...
        document.getElementById('orderCount').textContent = json_records.order_count;
        document.getElementById('pendingCount').textContent = json_records.pending_count;
        document.getElementById('approvedCount').textContent = json_records.approved_count;
        document.getElementById('notApprovedCount').textContent = json_records.not_approved_count;
        document.getElementById('cancelledCount').textContent = json_records.cancelled_count;
        document.getElementById('shipCount').textContent = json_records.ship_count;
        document.getElementById('deliveredCount').textContent = json_records.delivered_count;

        // Process orders
        json_records.orders.forEach(function (element) {
        ...
        // Optional: Remove a specific order if needed
