...
xhttp.onload = function () {
    var json_records = JSON.parse(this.responseText);   
        Array.from(json_records).forEach(function (element) {
            ...
            pagesList.add({
            id: `<a href="page-edit.php?id=`+element.id+`" class="fw-medium link-primary">${element.id}</a>`,           
            pageName: element.page_title,                
            headerName: element.header_name,
            footerName :element.footer_name,
