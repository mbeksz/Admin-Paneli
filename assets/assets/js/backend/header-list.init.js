...
xhttp.onload = function () {
    var json_records = JSON.parse(this.responseText);   
        Array.from(json_records).forEach(function (element) {
            ...
            pagesList.add({
            id: `<a href="header-edit.php?id=`+element.id+`" class="fw-medium link-primary">${element.id}</a>`,           
            menuName: element.title,    
            menuURL: `<a href="header-edit.php?id=`+element.id+`" class="fw-medium link-primary">${element.id}</a>`,           
