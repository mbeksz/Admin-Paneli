...
xhttp.onload = function () {
    var json_records = JSON.parse(this.responseText);   
        Array.from(json_records).forEach(function (element) {
            ...
            pagesList.add({
            id: `<a href="menu-edit.php?id=`+element.id+`" class="fw-medium link-primary">${element.id}</a>`,           
            menuName: element.name,    
            menuURL: `<a href="menu-edit.php?id=`+element.id+`" class="fw-medium link-primary">${element.id}</a>`,           
...
xhttp.open("GET", "/Yonetici/api/menus.php");
xhttp.send();
