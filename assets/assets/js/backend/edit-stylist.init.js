     ...
     document.addEventListener('DOMContentLoaded', function() {
             ...
             content = CodeMirror.fromTextArea(document.getElementById("page-content-input"), {
        ...
        function fetchMenuDetail() {
            ...
            xhttp_detail.open("GET", `/Yonetici/api/stylist.php?id=${idInput}`);
            xhttp_detail.send();
        }
        ...
        Array.prototype.slice.call(forms).forEach(function (form) {
            ...
            form.addEventListener('submit', function (event) {
                if (!form.checkValidity()) {
                    ...
                    xhttp_createPage.open("POST", "/Yonetici/api/stylist.php?id="+idInput);
