...
xhttp.onload = function () {
    var json_records = JSON.parse(this.responseText);   
        Array.from(json_records).forEach(function (element) {
            ...
            pagesList.add({
            id: `<a href="home-cart-edit.php?id=`+element.id+`" class="fw-medium link-primary">${element.id}</a>`,           
            name: element.title,    
            menuURL: `<a href="home-cart-edit.php?id=`+element.id+`" class="fw-medium link-primary">${element.id}</a>`,           
...
xhttp.open("GET", "/Yonetici/api/home-cart.php");
xhttp.send();
